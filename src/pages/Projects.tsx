...
export function Projects() {
  const projects: Project[] = [
    //////////////////////////////////////////////////
    {
      title: "NotesGuide.ai",
      date: "Mar 2, 2025",
      description: `NotesGuide.ai transforms study materials into smart, tailored notes for students and teachers using AI.  
It uses the OpenAI Ada v2 embedding model via API for accurate content retrieval.  
The Groq API with the Llama-3.3-70B LLM ensures fast, detailed responses.`,
      link: "https://notesguideai.streamlit.app/",
      githubUrl: "https://github.com/bpratik01/NotesGuide.ai",
      bulletPoints: ["Python, Streamlit, OpenAI, Groq"],
    },
    {
      title: "Pokenet",
      date: "May 22, 2024",
      description:
        "This project uses a deep learning model (ResNet-34) to classify Pokémon images. Built with Fastai and Streamlit, it's simple and easy to use.",
      link: "https://pokenet-bpratik01.streamlit.app/",
      githubUrl: "https://github.com/bpratik01/Pokenet",
      bulletPoints: ["Python, Fastai, Streamlit"],
    },
    {
    ...
    },
    {
      ...
      date: "Feb 8, 2025",
      description:
        "Omni-Vision is a computer vision project that aims at providing a semi-autonomus driving experience to the user.",
      link: "https://github.com/bpratik01/Omni_Vision",
      githubUrl: "https://github.com/bpratik01/Omni_Vision",
      bulletPoints: ["Python, TensorFlow, YOLO, OpenCV "],
    },
    {
      title: "MLOPS",
      date: "Jan 8, 2025",
      description:
        "A collection of scripts and projects that's all about the Ops in MLOps.",
      link: "https://github.com/bpratik01/MLOPS",
      githubUrl: "https://github.com/bpratik01/MLOPS",
      bulletPoints: ["Python, Docker, CI/CD", "Kubernetes, ArgoCD"],
    },
    {
      title: "yt-transcription",
      date: "Feb 5, 2025",
      description:
        "Transcribe YouTube videos effortlessly using Whisper (OpenAI) for accurate speech-to-text conversion.",
      link: "https://github.com/bpratik01/yt-transcription",
      githubUrl: "https://github.com/bpratik01/yt-transcription",
      bulletPoints: ["yt-dlp, Whisper (OpenAI), Python"],
    },
    {
      title: "US-Accident_Severity-Prediction",
      date: "Jan 11, 2025",
      description:
        "Predicting accident severity in the United States using advanced machine learning techniques, specifically XGBoost.",
      ...
      bulletPoints: ["Python, XGBoost, DVC, Git"],
    },
    {
      title: "NutriScan",
      date: "Aug 1, 2024",
      description:
        "NutriScan is a web app that uses Gemini API and Hugging Face Inference API to scan food images and provide instant nutritional information.",
      link: "https://github.com/bpratik01/NutriScan",
      githubUrl: "https://github.com/bpratik01/NutriScan",
      bulletPoints: ["Python, Hugging Face, Gemini API"],
    },

    {
      ...
      date: "Dec 25, 2024",
      description:
        "This project uses SQL to build an airport dashboard displaying available flights from various sources to destinations.",
      link: "https://github.com/bpratik01/Airport-Dashboard",
      githubUrl: "https://github.com/bpratik01/Airport-Dashboard",
      bulletPoints: ["Streamlit, Python, SQL"],
    },
  ];
  ///////////////////////////////////////////////////////////////////////
  return (
            ...
            <div className="p-6 flex-1 flex flex-col">
              ...
              <ul className="space-y-2 mb-6 flex-1">
                {project.bulletPoints.map((point, i) => (
                  <li
                    key={i}
                    className="flex items-start text-[13px] text-gray-600 dark:text-gray-400"
                  >
